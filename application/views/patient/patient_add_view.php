            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <?php echo form_open('patient/add', 'class="form-horizontal" id="add_patient_form"'); ?>
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="firstname" data-required="1" placeholder="enter first name" class="form-control input-height" value="<?=set_value("firstname")?>"/> </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="lastname" data-required="1" placeholder="enter last name" class="form-control input-height" value="<?=set_value("lastname")?>"/> </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input name="phone" type="text" placeholder="phone number" class="form-control input-height" value="<?=set_value("phone")?>"/> </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control input-height" name="email" placeholder="Email Address" value="<?=set_value("email")?>"> </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <textarea name="address" placeholder="address" class="form-control textarea" rows="5" ><?=set_value("address")?></textarea>
                                </div>
                            </div>
