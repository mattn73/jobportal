                    ...
                    <table class="table table-user-information ">
                        ...
                        <tr>
                            ...
                            <td><input type="text" value="<?= $seeker->lastname ?>" class="form-control"
                                       name="firstname" placeholder="Enter Lastname" required></td>
                        </tr>

                        <tr>
                            <td>Email:</td>
                            <td><input type="email" value="<?= $seeker->email ?>" class="form-control" name="email"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" value=" <?= $seeker->mobile ?>" class="form-control" name="mobile"
